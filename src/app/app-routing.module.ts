...
const routes: Routes = [
  ...
  { path: 'hacer-evaluacion-diaria-fms', loadChildren: './pages/hacer-evaluacion-diaria-fms/hacer-evaluacion-diaria-fms.module#HacerEvaluacionDiariaFmsPageModule' },
  { path: 'calendario-global', loadChildren: './pages/calendario-global/calendario-global.module#CalendarioGlobalPageModule' },
  //{ path: 'perfil-stats', loadChildren: './pages/perfil-stats/perfil-stats.module#PerfilStatsPageModule' },
  //{ path: 'ficha-clicnica2', loadChildren: './pages/ficha-clicnica2/ficha-clicnica2.module#FichaClicnica2PageModule' },
