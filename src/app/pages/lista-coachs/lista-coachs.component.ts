...
@Component({
  selector: 'app-lista-coachs',
  templateUrl: './lista-coachs.component.html',
  styleUrls: ['./lista-coachs.component.scss'],
})
export class ListaCoachsComponent implements OnInit {
